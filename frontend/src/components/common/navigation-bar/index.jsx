...
function NavigationBar() {
  ...
  return (
    <div className={styles.outerContainer}>
      <div className={styles.navigationPillContainer} onClick={() => navigate('./currency')}>
        <IconButton
          height="32px"
      ...
      <div className={styles.navigationPillContainer} onClick={() => navigate('./weather')}>
        <IconButton
          height="32px"
      ...
      <div className={styles.navigationPillContainer} onClick={() => navigate('./news')}>
        <IconButton
          height="32px"
      ...
      <div className={styles.navigationPillContainer} onClick={() => navigate('./locked')}>
        <IconButton
          height="32px"
